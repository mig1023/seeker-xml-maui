...
namespace SeekerMAUI.Output
{
    internal class Debug
    {
        ...
        public static StackLayout Information(int id)
        {
            ...
            info.Children.Add(Splitter.Line(new Thickness(0, 15), Colors.LightGray));

            string debug = Game.Data.Character.Debug();
        ...
        private static View GridParams(List<string> debugLines, Color fontColor)
        {
            ...
            {
                int column = 1 - ((i + 1) % 2);
                grid.Add(Line(fontColor, debugLines[i]), column, currentRow);
