...
namespace SeekerMAUI.Output
{
    class Disclaimer
    {
            ...
            ref StackLayout disclaimer, Frame border, Label change)
        {
            ...
            grid.Add(Element(head1, CloseTapped(border, change), little: true, bold: true));
            grid.Add(Element(body1, CloseTapped(border, change), little: true), 0, 1);
            grid.Add(Element(head2, CloseTapped(border, change), little: true, bold: true), 1, 0);
            grid.Add(Element(body2, CloseTapped(border, change), little: true), 1, 1);
